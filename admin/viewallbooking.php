...
<div class="col-lg-12">
     ...
     <table class="table">
      ...
      if(isset($_POST['btnsearch'])){
        ...
        $sql = "select booking.bookingid, booking.bookingdate, booking.person, theater.theater_name, theater.timing, theater.days, theater.price, theater.location, movies.title,  category.catname, users.name as 'username',booking.status from booking
        ...
        if(mysqli_num_rows($res) > 0){
          ...
          {
            $total_sale = $total_sale + $data['price'] * $data['person'];
            ?>
