  ...
  <div class="col-lg-6 mt-4">
    <form action="theater.php" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group mb-4">
         <input type="text" class="form-control" name="theater_name" value="" placeholder="enter theater name" required="">
      </div>
      ...
      <div class="form-group mb-4">
      <input type="time" class="form-control" name="timing" value="" required="">
      </div>

      <div class="form-group mb-4">
      <input type="text" class="form-control" name="days" value="" placeholder="enter days" required="">
      </div>

      <div class="form-group mb-4">
      <input type="number" class="form-control" name="price" value="" placeholder="enter price" required="">
      </div>
      ...
      <input type="submit" class="btn btn-primary" value="Add Theater" name="add" style="background-color: #343a40; border: none; padding: 10px 20px; font-size: 16px; border-radius: 5px; color: white;">
...
<div class="col-lg-6">
     ...
     <table class="table">
      ...
      <?php
      $sql = "SELECT theater.*, movies.title, category.catname from theater
...
{ 
  ...
  $sql = "INSERT INTO `theater`(`theater_name`,`timing`, `days`, `price`, `location`, `movieid`) VALUES ('$theater_name','$timing','$days','$price','$location','$movieid')";
...
if(isset($_GET['deleteid']))
{
  ...
  $sql = "DELETE FROM `theater` WHERE movieid='$deleteid'";
  if(mysqli_query($con,$sql))
  {
