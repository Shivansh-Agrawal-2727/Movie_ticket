...
<div class="row">
  <div class="col-lg-6">
    <form action="categories.php" method="post">
      ...
      <div class="form-group mb-4 ">
      <input type="text" class="form-control" name="catname" value="" placeholder="enter category" required="">
      </div>
      <div class="form-group ">
      <input type="submit" class="btn btn-primary" value="Add" name="add" style="background-color: #343a40; border: none; padding: 10px 20px; font-size: 16px; border-radius: 5px; color: white;">
...
if(isset($_GET['deleteid'])){
  ...
  $sql = "DELETE FROM `category` WHERE catid = '$deleteid'";
